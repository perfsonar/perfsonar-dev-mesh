...
cd /opt/perfsonar_ps/perfsonar-dev-mesh
...
cp /opt/perfsonar_ps/perfsonar-dev-mesh/maddash/gui_agent_configuration.conf /opt/perfsonar_ps/mesh_config/etc/gui_agent_configuration.conf
